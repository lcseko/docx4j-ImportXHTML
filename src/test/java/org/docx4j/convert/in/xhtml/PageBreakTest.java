...
public class PageBreakTest {
	...
	@Test
	public void testPageBreakAfter() throws Docx4JException {
		String content = "content";
        List<Object> objects = fromXHTML("<div style=\"page-break-after: always\"><p>" + content + "</p></div>");
    ...
    @Test
    public void testPageBreakBefore() throws Docx4JException {
        String content = "content";
        List<Object> objects = fromXHTML("<div style=\"page-break-before: always\"><p>" + content + "</p></div>");
        P p = (P) objects.get(0);
    ...
    private List<Object> fromXHTML(String content) throws Docx4JException {
        ...
        return XHTMLImporter.convert(content, "");
    }
